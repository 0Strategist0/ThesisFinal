...
def main() -> None:
    ...
    DATA_PATH = "/home/kye/Data/training_cHW_events.pkl"
    ...
    WEIGHT_COLUMN_NAMES_TO_SAVE = ['weight_sm', 'weight_cHW_pos0p01', 'weight_cHW_pos0p02', 'weight_cHW_pos0p05', 
                                   ...
                                   'weight_cHW_neg0p01', 'weight_cHW_neg0p02', 'weight_cHW_neg0p05', 
                                   'weight_cHW_neg0p1', 'weight_cHW_neg0p2', 'weight_cHW_neg0p5', 'weight_cHW_neg1p0']
    
    for i in range(0, 20):
        print(i)
        # Randomization
        SEED = 122807528840384100672342137670123435476 + i
        
        # Saving
        FAKE_DATA_SAVE_PATH = f"/home/kye/TestingModels/FakeData/100cHW/{i}_fake_data_cHW={C_VALUE}.pkl"
        FAKE_WEIGHTS_SAVE_PATH = f"/home/kye/TestingModels/FakeData/100cHW/{i}_fake_weights_cHW={C_VALUE}.pkl"
